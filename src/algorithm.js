...
const constContent = { placeOfLiving: 'Moscow', sex: 'male', age: 20, citizenship: 'russian', religion: 'atheist' , countryStart: 'russian' , countryEnd: 'usa', child: {age:13}}
const content = {tripDuration: 10, startCity: 'Moscow', endCity: 'London', health: 'healthy' , weather: { feelslike: 13, weatherDescriptions: 'дождливо'} }
...
const algorithm = (constContent, content) => {
    ...
    recommendedItems.push('Очень теплую непромокаемую одежду')
        } else if  (16 < compoundObj.weather.feelslike > 10){
